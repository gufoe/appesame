...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mapSwitch(R.id.switch_gps, "track_gps");
        mapSwitch(R.id.switch_realtime, "realtime_log");
        mapSwitch(R.id.switch_wifi, "track_wifi");
        mapSwitch(R.id.switch_reti, "track_reti");
        return mView;
    }
